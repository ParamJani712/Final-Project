...
figure;
subplot(2,1,1);
plot(tspan, fitRange, 'b-', 'LineWidth', 3);
title('Fit Polynomial for Range');
xlabel('Time(s)');
ylabel('Range(m)');

subplot(2,1,2);
plot(tspan, fitHeight, 'r-', 'LineWidth', 3);
title('Fit Polynomial for Height');
xlabel('Time(s)');
ylabel('Height(m)');
...
figure;
subplot(2,1,1);
plot(tspan, rangeRate, 'b-', 'LineWidth', 3);
...
subplot(2,1,2);
plot(tspan, heightRate, 'r-', 'LineWidth', 3);
